...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, SPI_RS_Pin|SPI_RESET_Pin|SPI_NSS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI_RS_Pin SPI_RESET_Pin SPI_NSS_Pin */
  GPIO_InitStruct.Pin = SPI_RS_Pin|SPI_RESET_Pin|SPI_NSS_Pin;
